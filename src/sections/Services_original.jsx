...
import { AnimatedTextLines } from '../components/AnimatedTextLines_original';

// Register GSAP plugins
gsap.registerPlugin(SplitText);

const Services_original = () => {
      ...
      <div ref={contextRef}>
        <div style={{ clipPath: 'polygon(0 0, 100% 0, 100% 100%, 0 100%)' }}>
          ...
          >
            ...
            <div className='px-10'>
              <h1 className='flex flex-col gap-12 uppercase banner-text-responsive sm:gap-16 md:block text-white'>
                <span>Service</span>
              </h1>
            </div>
          </div>
...
export default Services_original;
